...
export const RevealCaosVinculadosPrototype: React.FC = () => {
  return (
    <>
      <style>{`
        @keyframes spotlight {
        ...
        <main className="relative z-10 flex flex-col items-center gap-12 w-full max-w-lg p-6 hit-shake">
          ...
          <div className="text-center space-y-2 relative">
            ...
            <div className="stamp-reveal absolute top-0 w-[110vw] max-w-xl left-1/2 -translate-x-1/2 flex justify-center">
              <div className="whitespace-nowrap bg-white text-purple px-8 py-3 border-4 border-ink/5 shadow-[8px_8px_0px_rgba(43,45,66,0.3)] rounded-2xl rotate-[-5deg]">
