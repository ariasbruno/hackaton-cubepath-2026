...
const MOCK_PLAYERS = [
  ...
  { id: 'p2', nickname: 'Ivan', avatar: 'noto--fox', color: '#EF476F', role: 'INFILTRADO', isAlive: true },
...
export const RevealInfiltradoPrototype: React.FC = () => {
  // Inicializa en CERCANAS donde existe el Infiltrado, pero permite cambiar a TRADICIONAL
  const [mode, setMode] = useState<'TRADICIONAL' | 'CERCANAS'>('CERCANAS');
  ...
  const mockRoomState = {
    ...
    turnId: 'p3',
    currentRound: 1,
    // ID of the eliminated player (INFILTRATOR)
    lastEliminatedId: 'p2',
    lastEliminatedIds: ['p2'],
  };
