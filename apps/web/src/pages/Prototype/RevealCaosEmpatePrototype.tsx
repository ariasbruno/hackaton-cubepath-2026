...
export const RevealCaosEmpatePrototype: React.FC = () => {
  return (
    <>
      <style>{`
        @keyframes spotlight {
        ...
        @keyframes reveal-bg-purple {
            0% { background-color: #2B2D42; }
            100% { background-color: #310E68; }
        }
        @keyframes shake-hit {
        ...
        .scene-bg { animation: reveal-bg-purple 0.4s 3s forwards; background-color: #2B2D42; }
      ...
      <div className="scene-bg text-white font-sans min-h-screen w-screen flex flex-col items-center justify-center overflow-hidden relative">
        ...
        <main className="relative z-10 flex flex-col items-center gap-12 w-full max-w-lg p-6 hit-shake">
          {/* Fase 1: El Título - IDÉNTICO PARA SUSPENSO */}
          <div className="text-center space-y-2 relative">
            ...
            {/* Stamp del Resultado (solo aparece tras el hit) */}
            <div className="stamp-reveal absolute top-0 w-[110vw] max-w-xl left-1/2 -translate-x-1/2 flex justify-center">
              <div className="whitespace-nowrap bg-white text-purple-900 px-8 py-3 border-4 border-ink/5 shadow-[8px_8px_0px_rgba(43,45,66,0.3)] rounded-2xl rotate-[-5deg]">
          ...
          {/* Fase 2: Revelación de Jugadores - IDÉNTICO PARA SUSPENSO (2 placeholders) */}
          <div className="w-full flex items-center justify-center gap-30 md:gap-30 relative animate-shake-hard">
            ...
            <div className="flex flex-col animate-spotlight items-center gap-4">
              <div className="relative w-28 h-28 md:w-32 md:h-32 flex items-center justify-center">
                ...
                {/* En empate, mostramos solo un icono genérico tras el reveal o nada */}
                <div className="w-24 h-24 md:w-28 md:h-28 rounded-full overflow-hidden bg-white/10 border-4 border-ink shadow-hard avatar-hidden relative z-10 flex items-center justify-center">
                   <span className="material-symbols-outlined text-white/10 text-5xl">person</span>
                </div>
              </div>
            </div>
          ...
          <div className="flex flex-col items-center gap-8 mt-2">
            <p 
              className="text-sm md:text-base font-medium text-white/60 leading-relaxed px-8 text-center opacity-0" 
              style={{ animation: 'name-in 0.5s 4.5s forwards' }}
            >
              Nadie alcanzó la mayoría absoluta. <br />
              La pareja sigue oculta entre nosotros.
            </p>
          </div>
          ...
          >
            <div className="flex items-center justify-center gap-3 text-white">
              ...
              <p className="font-mono uppercase tracking-[0.3em] text-[10px] font-black drop-shadow-md">Preparando siguiente ronda...</p>
            </div>
          </div>
        </main>
      </div>
