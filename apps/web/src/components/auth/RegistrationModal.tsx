...
export const RegistrationModal: React.FC<RegistrationModalProps> = ({ isOpen, onClose, onSuccess }) => {
	...
	return (
      ...
      <Modal.Header title="Completa tu Perfil" />
      <Modal.Body>
        ...
        <form id="registration-form" onSubmit={handleFinalSetup} className="space-y-4">
      ...
      <Modal.Footer>
        <Button type="submit" form="registration-form" fullWidth size="lg" disabled={loading}>
